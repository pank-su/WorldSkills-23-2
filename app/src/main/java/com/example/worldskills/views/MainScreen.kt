...
fun MainScreen() {
    ...
    val items = listOf(
        Screen("Анализы", R.drawable.del_icon) { Analyzes() },
        Screen("Результаты", R.drawable.del_icon) { Analyzes() },
        Screen("Поддержка", R.drawable.del_icon) { Analyzes() },
        Screen("Профиль", R.drawable.del_icon) { Analyzes() }
    )
    Scaffold(
        bottomBar = {
            NavigationBar {
